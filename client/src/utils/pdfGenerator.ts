      ...
      <body>
        <div class="header">
          <div>
            ...
            <div class="subtitle">Thrive Clinical Risk Intelligence Platform · Generated on ${dateStr}</div>
          </div>
        ...
        <div class="footer">
          This document is generated by Thrive Patient Follow-up Risk Predictor. Rules-based engine · 100% Explainable.
        </div>
      ...
      <body>
        <div class="header">
          <div>
            ...
            <div class="subtitle">Thrive Patient Risk Predictor · Generated on ${dateStr}</div>
          </div>
        ...
        <div class="footer">
          Thrive Clinical Risk Intelligence System · Confidential Patient Report
        </div>
